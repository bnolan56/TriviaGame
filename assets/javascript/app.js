...
//// FUNCTIONS ////
  ...
  function showScoreboard() {
    ...
    $('#rightanswers').html("Correct answers: " + correctAnswers);
    $('#wronganswers').html("Incorrect answers: " + incorrectAnswers);
  }
  ...
  function correctChoiceShown() {
    $('#results').html(charDee[questionIndex].correctChoice);
  }

  // function that shows the wrong choice
  function incorrectChoiceShown() {
    $('#results').html(charDee[questionIndex].incorrectChoice);
  }
  ...
  function winCheck() {
    ...
    if (scoreCalc >= 70) {
      ...
      $('#choices').html("YOU WIN WITH AN AMAZING " + totalScore);
      $('#choices').append("<button class='btn resetbutton'>Reset Game</button>")
    ...
    if (scoreCalc < 70) {
      ...
      $('#choices').html("YOU LOSE WITH A TERRIBLE " + totalScore);
      $('#choices').append("<button class='btn resetbutton'>Reset Game</button>")
      $('.resetbutton').on("click", function () {
        location.reload();
      });
